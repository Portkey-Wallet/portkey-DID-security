...
public class CASecurityMongoDBGrainStorageConfigurator : IPostConfigureOptions<MongoDBGrainStorageOptions>
{
    private readonly IServiceProvider _serviceProvider;

    public CASecurityMongoDBGrainStorageConfigurator(IServiceProvider serviceProvider)
    {
